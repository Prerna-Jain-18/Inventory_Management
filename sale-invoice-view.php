...
$sale = $db->select("sale", "*", ['sale_id' => $sale_id])[0];
$sale_items = $db->select("sale_items", "*", ['sale_id' => $sale_id]);
?> 
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"> 
                ...
                <div class="card"> 
                    <div class="card-header-lg">
                        ...
                        <div class="text-end">
                            <a href="test.php" class="btn btn-primary">Create Invoice</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="invoice-details">
                                        <address class="m-0">
                                            ...
                                            Mobile No.-  <?php echo $sale['mobile_no']; ?><br>
                                            GST No.-<?php echo $sale['gstin']; ?>                                            
                                        </address>
                                        <div class="invoice-num">
                                            <div>Date - <?php echo $sale['date']; ?></div>
                                            <div>Invoice No - <?php echo $sale['sale_id']; ?></div>
                                            <div></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>                                                    
                                                    ...
                                                    <td>
                                                        <h5 class="mt-2 text-danger"><?php echo $sale['grand_total']; ?> (Rs)</h5>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
