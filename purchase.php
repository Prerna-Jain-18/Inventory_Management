<?php
include 'header.php';
if (isset($_SESSION['newPurchaseBill'])) {
    unset($_SESSION['newPurchaseBill']);
    $_SESSION['newPurchaseBill'] = NULL;
}
?>
...
<div class="content-wrapper-scroll">
    ...
    <div class="content-wrapper">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <!-- Card start -->
            <div class="card">
                <form method="POST" id="sale_form" action="purchase-data.php" enctype="multipart/form-data">
                    <div class="card-header-lg">
                        <h4>Create Invoice(Purchase)</h4>
                        <div class="graph-day-selection" role="group">
                            <a type="button" href="purchase-report.php" class="btn active">View All Invoices </a>
                        </div>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-12">
                                ...
                                <div class="row gutters">
                                    <div class="col-12">
                                        <div class="form-section-header light-bg">Customer Details
                                            <div class="graph-day-selection" role="group">
                                                <a type="button" href="ledger.php" class="btn active"> Add New Customer </a>
                                            </div>
                                        </div>
                                    </div>
                                    <input type ="hidden" name="customer_id"  id="customer_id"><br>
                                    <div class="col-6">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">

                                            <input class="form-control" type="text" autofocus="" required="" name="customer_name" id="customer_name">
        ...
        $("#sale_form").submit(function (event) {
            ...
            $.ajax({
                ...
                if (!obj.is_error) {
                    if (confirm(obj.msg))
                    {
                        window.location = "purchase-invoice-view.php?purchase_id=" + obj.last_id;
                    } else {
...
<script>
    ...
    function delete_item(id)
    {
        ...
        $.ajax({
            type: "POST",
            url: "purchase-item-delete.php?id=" + id
