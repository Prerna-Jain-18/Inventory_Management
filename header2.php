...
function get_ledger_name($id) {
    return $_SESSION['ledger_data'][$id]['ledger_name'];
}
?>
                        ...
                        <div class="tab-pane fade" id="tab-forms" role="tabpanel" aria-labelledby="forms-tab">
                            ...
                            <div class="sidebarMenuScroll">
                                <div class="sidebar-menu">
                                    <ul>
                                        <li>
                                            <a href="transaction.php?type=payment">Payment</a>
                                        </li>
                                        <li>
                                            <a href="transaction.php?type=receipt">Receipt</a>
                                        </li>
                                        <li>
                                            <a href="transaction.php?type=contra">Contra</a>
                                        </li>
                            ...
                            <div class="sidebarMenuScroll">
                                <div class="sidebar-menu">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="apex-graphs.html">Add Purchase</a>
                                        </li>
                                        <li>
                                            <a href="morris-graphs.html">Manage Purchase</a>
                                        </li>
                        ...
                        <div class="tab-pane fade" id="tab-authentication" role="tabpanel" aria-labelledby="authentication-tab">
                            ...
                            <div class="sidebarMenuScroll">
                                <div class="sidebar-menu">
                                    <ul>
                                        <li>
                                            <a href="sale-bill.php">Add Sale</a>
                                        </li>
                                        <li>
                                            <a href="signup.html">Manage Sale</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="tab-reports" role="tabpanel" aria-labelledby="reports-tab">
                            ...
                            <div class="sidebarMenuScroll">
                                <div class="sidebar-menu">
                                    <ul>
                                        <li>
                                            <a href="report.php">Ledger Reports</a>
                                        </li>
