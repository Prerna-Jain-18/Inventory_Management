...
if (isset($_SESSION['newSaleBill'])) {
    unset($_SESSION['newSaleBill']);
    $_SESSION['newSaleBill'] = NULL;
}
?>
...
<div class="content-wrapper-scroll">
    ...
    <div class="content-wrapper">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <!-- Card start -->
            <div class="card">
                <form method="POST" id="sale_form" action="sale-data.php" enctype="multipart/form-data">
                    <div class="card-header-lg">
                        <h4>Create Invoice</h4>
                        <div class="graph-day-selection" role="group">
                            <a type="button" href="sale-report.php" class="btn active">View All Invoices </a>
                        </div>
                    </div>
                    <div class="card-body">
        ...
        $("#sale_form").submit(function (event) {
            ...
            $.ajax({
                ...
                if (!obj.is_error) {
                    if (confirm(obj.msg))
                    {
                        window.location = "sale-invoice-view.php?sale_id=" + obj.last_id;
                    } else {
...
<script>
    ...
    function delete_item(id)
    {
        ...
        $.ajax({
            type: "POST",
            url: "sale-item-delete.php?id=" + id
