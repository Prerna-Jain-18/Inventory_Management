...
$id = $_REQUEST['id'];
$db = new Database();
$company_data = $db->select('company', "*", ['company_id' => $id])[0];
?>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body mt-4">
                        <form method="POST" action="company-update-save.php" enctype="multipart/form-data">
                        ...
                        <div class="row gutters">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="name" value="<?php echo $company_data['company_name']; ?>">
                                    </div>
                             ...
                             <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">														
                                        <input type="file" class="form-control" id="inputGroupFile01" name="logo" value="<?php echo $company_data['company_logo']; ?>">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="number" name="pan" value="<?php echo $company_data['pan_number']; ?>">
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text"name="gst" value="<?php echo $company_data['gst_no']; ?>">
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="email" name="email" value="<?php echo $company_data['email']; ?>">
                             ...
                             <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="landline" value="<?php echo $company_data['landline']; ?>">
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="mobile" value="<?php echo $company_data['mobile_number']; ?>">
                                        <span class="input-group-text">
                             ...
                             <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="address1" value="<?php echo $company_data['address1']; ?>">
                                    </div>
                             ...
                             <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="address2" value="<?php echo $company_data['address2']; ?>">
                                    </div>
                             ...
                             <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="city" value="<?php echo $company_data['city']; ?>">
                                    </div>
                             ...
                             <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="taluka" value="<?php echo $company_data['taluka']; ?>">
                                    </div>
                             ...
                             <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="district" value="<?php echo $company_data['district']; ?>">
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="field-wrapper">
                                    <div class="field-wrapper">
                                        <select class="form-select" id="formSelect" name="state" value="<?php echo $company_data['state']; ?>">
                             ...
                             <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="country" value="<?php echo $company_data['country']; ?>">
                                    </div>
                             ...
                             <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="number" name="pincode" value="<?php echo $company_data['pincode']; ?>">
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="bank_name" value="<?php echo $company_data['bank_name']; ?>">
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="branch" value="<?php echo $company_data['branch']; ?>">
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                               <!-- Field wrapper start -->
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="account_no" value="<?php echo $company_data['account_number']; ?>">
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="ifsc" value="<?php echo $company_data['ifsc_code']; ?>">
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                ...
                                <div class="field-wrapper">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="upi" value="<?php echo $company_data['upi_id']; ?>">
                                    </div>
