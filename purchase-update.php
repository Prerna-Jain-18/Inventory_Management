...
$id = $_REQUEST['id'];
$db = new Database();
$purchase_data = $db->select('purchase', "*", ['purchase_id' => $id])[0];
$purchase_items = $db->select("purchase_items", "*", ["purchase_id" => $id]);
$_SESSION['newPurchaseBill'] = $purchase_items;
?>
...
<div class="content-wrapper-scroll">
    ...
    <div class="content-wrapper">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <!-- Card start -->
            <div class="card">
                <form method="POST" id="sale_form" action="purchase-update-save.php" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-12">
                                ...
                                <div class="row gutters">
                                    ...
                                    <input type ="text"  hidden name="purchase_id"  value="<?php echo $purchase_data['purchase_id'] ?>"><br>
                                    <div class="col-6">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">

                                            <input class="form-control" type="text" autofocus="" name="customer_name" id="customer_name" value="<?php echo $purchase_data['customer_name']; ?>">
                                    ...
                                    <div class="col-xl-6">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="text" id="name" name="name" value="<?php echo $purchase_data['customer_name']; ?>">
                                    ...
                                    <div class="col-xl-6">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="text" id="mobile_no" name="mobile_no" value="<?php echo $purchase_data['mobile_no']; ?>">
                                    ...
                                    <div class="col-xl-6">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="text" name="gstin" id="gstin"value="<?php echo $purchase_data['gstin']; ?>">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-7 col-sm-7 col-12">
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="field-wrapper">
                                            <div class="input-group">
                                                <input type="text" class="form-control datepicker" id="date" name="date" value="<?php echo $purchase_data['date']; ?>">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="field-wrapper">
                                            <div class="field-wrapper">
                                                <select class="form-select" id="payment_mode" name="payment_mode" value="<?php echo $purchase_data['payment_mode']; ?>">
                                    ...
                                    <div class="col-xl-6">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="text" id="payment_details" name="payment_details"   value="<?php echo $purchase_data['payment_details']; ?>">
                                    ...
                                    <div class="col-xl-6">
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="text" name="narration" id="narration"  value="<?php echo $purchase_data['narration']; ?>">
...
<script>
    $(document).ready(function () {
        $("#itemsList").load("purchase-bill-item-list.php");
